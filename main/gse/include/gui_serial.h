...
//		uint8 					packet_body[8192];			//!< Complete packet body
		...
		char buff[2048];									//!< Dump wasted data //xin:although referenced in gui_serial.cpp, this is useless
//		char buff[8192];									//!< Dump wasted data //xin:although referenced in gui_serial.cpp, this is useless
