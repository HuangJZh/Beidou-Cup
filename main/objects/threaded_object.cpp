...
Threaded_Object::Threaded_Object(const char _task_name[11])
{
	int64_t lcv;
...
/*----------------------------------------------------------------------------------------------*/
uint64_t Threaded_Object::Trylock()
{
...
/*----------------------------------------------------------------------------------------------*/
uint64_t Threaded_Object::getExecTic()
{
...
/*----------------------------------------------------------------------------------------------*/
uint64_t Threaded_Object::getStartTic()
{
	return(start_tic);
}
/*----------------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------------*/
uint64_t Threaded_Object::getStopTic()
{
	return(stop_tic);
}
/*----------------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------------*/
uint64_t Threaded_Object::getSize()
{
	return(size);
}
/*----------------------------------------------------------------------------------------------*/
...
/*----------------------------------------------------------------------------------------------
uint64_t Threaded_Object::getStack()
{
	return(stack);
}
----------------------------------------------------------------------------------------------*/
